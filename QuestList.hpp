...
Michelle Khanan
November 10 2023
QuestList.hpp declares the Quest struct and QuestList class along with its public members
*/
...
struct Quest
{
    ...
    */
    Quest(const std::string& title, const std::string& description, bool completed, int experience_points, const std::vector<Quest*>& dependencies, const std::vector<Quest*> subquests) : title_(title), description_(description), completed_(completed), experience_points_(experience_points), dependencies_(dependencies), subquests_(subquests)
    {
...
class QuestList : public DoublyLinkedList<Quest*>
{
    ...
    */
    int getPosOf(const std::string& quest_title);
    ...
    */
    bool contains(const std::string& quest_title);
    ...
    */
    bool addQuest(const std::string& title, const std::string& description, bool completed, int experience_points, const std::vector<Quest*>& dependencies, const std::vector<Quest*>& subquests);
    ...
    */
    ...
    void questQueryHelper(const std::string& quest_title);
    ...
    */
    ...
    void printQuestDetailsHelper(Quest* main_quest);
