...
enum Dagger {WOOD, BRONZE, IRON, STEEL, MITHRIL, ADAMANT, RUNE}; //an enum Dagger with the values {WOOD, BRONZE, IRON, STEEL, MITHRIL, ADAMANT, RUNE}
...
class Scoundrel : public Character
{
    public:
        ...
        */
        ...
        @post       : The private members are set to the values of the corresponding 
                    ...
                    set to "NONE". 
        */
        Scoundrel(const string& name, const string& race, int vitality = 0, int armor = 0, int level = 0, bool enemy = false, string dagger = "WOOD", string faction = "NONE", bool has_disguise = false);
        /**
    ...
    private:
        ...
        string faction_; //A string that represents their Faction
        bool has_disguise_; //A boolean indicating if they have a disguise
};
